...
namespace OpenTK.Wpf {
    ...
    internal sealed class DxGlContext : IDisposable {
        ...
        public DxGlContext([CanBeNull] IGraphicsContext graphicsContext) {
            ...
            if (graphicsContext == null) {
                graphicsContext = RetrieveSharedOpenGLContext();
            }
        ...
        private static IGraphicsContext RetrieveSharedOpenGLContext() {
