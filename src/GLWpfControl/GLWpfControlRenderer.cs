...
namespace OpenTK.Wpf
{
    ...
    internal sealed class GLWpfControlRenderer : IDisposable
    {
        ...
        public void ReallocateFramebufferIfNeeded(double width, double height, double dpiScaleX, double dpiScaleY, Format format, MultisampleType msaaType)
        {
            ...
            if (D3dImage == null || FramebufferWidth != newWidth || FramebufferHeight != newHeight || MultisampleType != msaaType)
            {
                ...
                if (width > 0 && height > 0)
                {
                    ...
                    bool success;
                    success = Wgl.NV.DXSetResourceShareHandleNV(DxColorRenderTarget.Handle, dxColorRenderTargetShareHandle);
                    if (success == false)
                    {
                    ...
                    success = Wgl.NV.DXSetResourceShareHandleNV(dxDepthStencilRenderTarget.Handle, dxDepthStencilRenderTargetShareHandle);
                    if (success == false)
                    {
        ...
        public void Render(DrawingContext drawingContext)
        {
            ...
            System.Windows.Rect rect = new System.Windows.Rect(0, 0, D3dImage.Width, D3dImage.Height);
