...
namespace OpenTK.Wpf.Renderers
{
    ...
    internal sealed class GLWpfControlDirectSurfaceRenderer : IGLWpfControlRenderer
    {
        ...
        public GLWpfControlDirectSurfaceRenderer(DxGlContext context)
        {
            _context = context;
